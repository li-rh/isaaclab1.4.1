...
# add_app_launcher_args() 方法将脚本参数与 AppLauncher 界面合并，该方法会返回一个修改过的 ArgumentParser ，
# 其中包含 AppLauncher 参数。然后可以使用标准的 argparse.ArgumentParser.parse_args() 方法
# 将其处理为一个 argparse.Namespace ，并直接传递给 AppLauncher 进行实例化。
